		...
		struct lttng_event_notifier_group *event_notifier_group)
{
	...
	cds_list_for_each_entry(event_notifier,
			&event_notifier_group->event_notifiers_head, node)
		_lttng_event_notifier_unregister(event_notifier);

	synchronize_trace();

	cds_list_for_each_entry_safe(event_notifier_enabler,
			tmpevent_notifier_enabler,
			&event_notifier_group->enablers_head, node)
		lttng_event_notifier_enabler_destroy(event_notifier_enabler);

	cds_list_for_each_entry_safe(event_notifier, tmpevent_notifier,
			&event_notifier_group->event_notifiers_head, node)
